...
class ChartWithBollinger extends React.Component {
	render() {
		const ema20 = ema()
			.options({
...
ChartWithBollinger.defaultProps = {
	type: "svg",
};
ChartWithBollinger = fitWidth(ChartWithBollinger);

export default ChartWithBollinger;
